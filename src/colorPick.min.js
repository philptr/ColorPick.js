(function(a){a.fn.colorPick=function(c){return this.each(function(){new a.colorPick(this,c||{})})};a.colorPick=function(c,b){b=b||{};this.options=a.extend({},a.fn.colorPick.defaults,b);b.str&&(this.options.str=a.extend({},a.fn.colorpickr.defaults.str,b.str));a.fn.colorPick.defaults=this.options;this.color=this.options.initialColor;this.element=a(c);var e=this.element.data("initialcolor");e&&(this.color=e,this.appendToStorage(this.color));var d=[];a.each(a.fn.colorPick.defaults.palette,function(c,
b){-1===a.inArray(b,d)&&d.push(b)});a.fn.colorPick.defaults.palette=d;return this.element.hasClass(this.options.pickrclass)?this:this.init()};a.fn.colorPick.defaults={initialColor:"#3498db",paletteLabel:"Default palette:",allowRecent:!0,recentMax:5,allowCustomColor:!1,palette:"#1abc9c #16a085 #2ecc71 #27ae60 #3498db #2980b9 #9b59b6 #8e44ad #34495e #2c3e50 #f1c40f #f39c12 #e67e22 #d35400 #e74c3c #c0392b #ecf0f1 #bdc3c7 #95a5a6 #7f8c8d".split(" "),onColorSelected:function(){this.element.css({backgroundColor:this.color,
