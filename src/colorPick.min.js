...
a.proxy(b.options.onColorSelected,b)();b.hide();return!1});a(document).click(function(a){b.hide();return!0});return this},appendToStorage:function(b){if(!0===a.fn.colorPick.defaults.allowRecent){var c=JSON.parse(localStorage.getItem("colorPickRecentItems"));null==c&&(c=[]);-1==a.inArray(b,c)&&(c.unshift(b),c=c.slice(0,a.fn.colorPick.defaults.recentMax),localStorage.setItem("colorPickRecentItems",JSON.stringify(c)))}},show:function(b,c){a("body").append('<div id="colorPick" style="display:none;top:'+
